...
var ContextMenu = function () {
    ...
    ContextMenu.prototype.invoke = function invoke(target, mouseEvent, ctxMenu) {
        var _this2 = this;

        var beforeRender = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (m) {
            return m;
        };
